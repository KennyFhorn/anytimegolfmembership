...
2. In the SQL Editor, run the migrations in order: `supabase/migrations/0001_init.sql`,
   `0002_auth_linking.sql`, `0003_password_signup.sql`, `0004_member_profile_fields.sql` — these
   create all tables, RLS policies, the auth triggers, and a starter "Fall 2026 League" season.
